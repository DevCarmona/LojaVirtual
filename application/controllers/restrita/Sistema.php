...
class Sistema extends CI_Controller {
    ...
    {   
        $this->form_validation->set_rules('config_email', '<strong>E-mail de acesso</strong>', 'trim|required|valid_email');
        $this->form_validation->set_rules('config_token', '<strong>Token de acesso</strong>', 'trim|required|max_length[100]');
