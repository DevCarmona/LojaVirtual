						...
						<?php echo form_open("restrita/produtos/core/" . $produto_id, $atributos); ?>
							<div class="card-body">
								<?php if(isset($produto)): ?>
									<div class="form-row">
										<div class="col-md-12">
											<label for="">Meta link do produto</label>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<input name="produto_nome" type="text" class="form-control" value="<?php echo (isset($produto) ? $produto->produto_nome : set_value('produto_nome')); ?>">
								...
								<div class="form-row">
									<div class="form-group col-md-2">
										...
										<input name="produto_valor" type="text" class="form-control money2" value="<?php echo (isset($produto) ? $produto->produto_valor : set_value('produto_valor')); ?>">
										<?php echo form_error('produto_valor', '<div class="text-danger">', '</div>'); ?>
									</div>

									<div class="form-group col-md-2">
										<label>Peso do produto</label>
										<input name="produto_peso" type="number" class="form-control" value="<?php echo (isset($produto) ? $produto->produto_peso : set_value('produto_peso')); ?>">
										<?php echo form_error('produto_peso', '<div class="text-danger">', '</div>'); ?>
									</div>

									<div class="form-group col-md-2">
										<label>Altura do produto</label>
										<input name="produto_altura" type="number" class="form-control" value="<?php echo (isset($produto) ? $produto->produto_altura : set_value('produto_altura')); ?>">
										<?php echo form_error('produto_altura', '<div class="text-danger">', '</div>'); ?>
									</div>

									<div class="form-group col-md-2">
										<label>Largura do produto</label>
										<input name="produto_largura" type="number" class="form-control" value="<?php echo (isset($produto) ? $produto->produto_largura : set_value('produto_largura')); ?>">
										<?php echo form_error('produto_largura', '<div class="text-danger">', '</div>'); ?>
									</div>

									<div class="form-group col-md-2">
										<label>Comprimento do produto</label>
										<input name="produto_comprimento" type="number" class="form-control" value="<?php echo (isset($produto) ? $produto->produto_comprimento : set_value('produto_comprimento')); ?>">
								...
								<div class="form-row">
									<div class="form-group col-md-2">
										...
										<input name="produto_quantidade_estoque" type="number" class="form-control" value="<?php echo (isset($produto) ? $produto->produto_quantidade_estoque : set_value('produto_quantidade_estoque')); ?>">
								...
								<div class="form-row">
									<div class="form-group col-md-8">
										...
										<textarea class="form-control" name="produto_descricao" rows="2" min-height="100px"><?php echo (isset($produto) ? $produto->produto_descricao : set_value('produto_descricao')); ?></textarea>
										<?php echo form_error('produto_descricao', '<div class="text-danger">', '</div>'); ?>
									</div>
								</div>	

								<!-- Loading image not working / Upload de imagem não está funcionando -->
								<div class="form-row">
									<div class="form-group col-md-8">
											...
											<div id="uploaded_image" class="text-danger">
												<?php foreach($fotos_produto as$foto): ?>
													<ul style="list-style:none; display:inline-block">
														<li>
															<img src="<?php echo base_url('uploads/produtos/'.$foto->foto_caminho); ?>" width="80" class="image_thumbnail mr-1 mb-2">
