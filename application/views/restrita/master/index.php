                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-block">
                            <h4>Categoria pai cadastradas</h4>
                            <a class="btn btn-primary float-right"
                                href="<?php echo base_url('restrita/master/core') ?>">Cadastrar</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach($master as $pai): ?>
                                            <tr>
                                                ...
                                                <td><i class="text-info" data-feather="external-link" style="width: 16px; height: 16px;"></i>&nbsp;<?php echo $pai->categoria_pai_meta_link; ?></td>
