                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-block">
                            <h4>Categoria filho cadastradas</h4>
                            <a class="btn btn-primary float-right"
                                href="<?php echo base_url('restrita/categorias/core') ?>">Cadastrar</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach($categorias as $categoria): ?>
                                            <tr>
                                                ...
                                                <td><i class="text-info" data-feather="external-link" style="width: 16px; height: 16px;"></i>&nbsp;<?php echo $categoria->categoria_meta_link; ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url('restrita/categorias/delete/' . $categoria->categoria_id) ?>" class="btn btn-icon btn-danger delete" data-confirm="Tem certeza da exclusão da categoria filho?"><i class="fas fa-times"></i></a>
                                                </td>
