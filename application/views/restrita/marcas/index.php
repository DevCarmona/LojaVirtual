                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-block">
                            <h4>Lista de marcas cadastradas</h4>
                            <a class="btn btn-primary float-right"
                                href="<?php echo base_url('restrita/marcas/core') ?>">Cadastrar</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach($marcas as $marca): ?>
                                            <tr>
                                                ...
                                                <td><i class="text-info" data-feather="external-link" style="width: 16px; height: 16px;"></i>&nbsp;<?php echo $marca->marca_meta_link; ?></td>
