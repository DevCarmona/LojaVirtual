                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <ul class="des">
                            ...
                            <li>
                                <span>Endereço: </span>
                                <?php echo $sistema->sistema_endereco . ', ' . $sistema->sistema_numero . ' - ' . 'CEP:&nbsp;' . $sistema->sistema_cep . ' - ' . $sistema->sistema_cidade . ',&nbsp;' . $sistema->sistema_estado ?>
                            </li>
...
<!-- Wow.min js -->
<script src="<?php echo base_url('public/web/js/wow.min.j');?>s"></script>
<!-- Slick Carousel js -->
